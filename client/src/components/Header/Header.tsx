...
function Header() {
  ...
  return (
    <div className="fixed w-full backdrop-blur bg-white/5">
      <div className="hidden bg-white/10 h-10 backdrop-blur md:flex justify-between px-128 items-center items-center cursor-pointer shadow-sm">
        <div><DiYii /></div>
        ...
        <div className="flex flex-row gap-4 items-center">
          ...
          <button
            ...
            className="hover:bg-gray-100 border border-gray-200 h-7 w-16 rounded-sm text-sm flex items-center justify-center font-instrument text-lg"
          >
            Signin
          </button>
      ...
      <div className="md:hidden flex justify-between p-2 bg-white/10 backdrop-blur">
        ...
        {isOpen && (
          <div className="absolute top-12 right-2 bg-white border p-2 flex flex-col gap-3 shadow-md">
