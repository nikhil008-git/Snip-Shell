...
function Header() {
  ...
  return (
    <div className="fixed w-full backdrop-blur bg-white/5 z-50">
      ...
      <div className="md:hidden flex justify-between p-2 bg-white/10 backdrop-blur">
        ...
        {isOpen && (
          <div className="absolute top-12 right-2 bg-white w-full flex flex-col justify-center items-center border p-2 flex flex-col gap-3 shadow-md">
            <button
              onClick={() => setShowModal(true)}
              className="hover:bg-gray-100 border border-gray-500 h-7 w-full rounded-sm text-sm flex items-center justify-center font-instrument font-thin text-lg"
            >
              Signin
            </button>
            ...
            <button
              ...
              className="hover:bg-gray-600 border border-gray-500 h-7 w-full bg-black text-white rounded-sm text-sm flex items-center justify-center font-instrument font-thin text-lg"
            >
              Signup
            </button>
