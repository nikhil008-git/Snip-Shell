    ...
    <>
      <div>
        <img
          src={downarrow}
          alt="down arrow"
          className="hidden md:block sm:w-10 sm:h-10 md:w-20 md:h-20 md:absolute md:top-56 md:right-100 xl:right-120 md:-rotate-10"
        />
      </div>
      ...
      <div className="h-screen w-full bg-[url('/squares.png')] bg-no-repeat bg-top bg-[length:1200px_1000px]">
        <div className="flex flex-col items-center h-screen pt-20">
          <Link
            to="/"
            className="font-instrument text-6xl cursor-pointer  font-bold"
          >
            {" "}
            Snip-Shell{" "}
          </Link>
          <div></div>
          <div
            className="font-satoshi font-black italic cursor-pointer text-gray-700 
                text-3xl sm:text-4xl md:text-5xl mt-6 sm:mt-8 md:mt-10"
          >
            your{" "}
            <span className="font-instrument font-bold underline text-black">
              thoughts
            </span>{" "}
            go to grow
          </div>
          ...
          <div>
            <img
              ...
              style={{
                boxShadow:
                  "0 -10px 15px -3px rgba(0,0,0,0.3), -10px 0 15px -3px rgba(0,0,0,0.3), 10px 0 15px -3px rgba(0,0,0,0.3)",
              }}
            />
          </div>
